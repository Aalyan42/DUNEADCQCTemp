...
def calc_plot_dnl_inl(indata, dirsave=None, asicID='', NumSet=480):
    ...
    NChan = 16  #LBL changing these to skip deserialization process since our file is alr deserialized
    NWORDFIFO = 65536
    ...
    ########subprocess.run(['./deserialize', 'rawLinData.bin', 'LinData.bin', str(NumSet)]) ##changed ./deserialize to path
    # print('Reading deserialized data . . .')
    # array formatted for further processing
    y = np.fromfile(r"C:\Users\rts-operator\BNL_CE_WIB_SW_QC\TestData\Time_20250729175352_DUT_1000_2000_3000_4000_5000_6000_7000_8000\rt_ADC_000100001_000100002_000100003_000100004_000100005_000100006_000100007_000100008\QC_DNL_INL.bin", dtype=np.uint16).reshape(NTimeStp, NChan)
    # DEBUG
    print(y)
    print(type(y))
...
if __name__ == "__main__":
    ...
    path = r"C:\Users\rts-operator\BNL_CE_WIB_SW_QC\TestData\Time_20250729175352_DUT_1000_2000_3000_4000_5000_6000_7000_8000\rt_ADC_000100001_000100002_000100003_000100004_000100005_000100006_000100007_000100008\QC_DNL_INL.bin"
    indata = np.fromfile(path, dtype=np.uint8)

    calc_plot_dnl_inl(indata, dirsave=".", asicID="test", NumSet=480 )